...
public class Sketch {
	...
	public synchronized int container(int x, int y) {
		// TODO: YOUR CODE HERE
		for (int i = (shapes.size()-1); i>=0; i--) {		//starting from topmost i.e. the end of the shapes arraylist and decrements
		...
		return -1;	// if none of the shape in lists of shape contains the point, then return null for index
	}
